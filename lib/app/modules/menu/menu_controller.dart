...
abstract class _MenuBase with Store {
  ...
  _MenuBase(){
    ...
    this.menus.add(BottomNavigationBarModel(screenId: 0, icon: Icons.home, label: CustomLocalizations.of(navigatorKey.currentContext).translate("Home"), getPage: ()=>HomePage()));
    this.menus.add(BottomNavigationBarModel(screenId: 1, icon: Icons.calendar_today, label: "Agenda", getPage: ()=>SchedulePage()));
